...
class Konfirmasi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $d['nav1'] = "Produktivitas";
        $d['title'] = "Konfirmasi Saldo";
        ...
        $d['get_uang_masuk'] = $this->uang_masuk->get_uang_masuk_konfirmasi();
    ...
    function update()
    {
        ...
        if ($this->session->userdata('logged_in') and $role == 'Administrator') {
            ...
            $id_uang_masuk = $this->input->post('id_uang_masuk', true);
            $kode_donatur = $this->input->post('kode_donatur', true);
            $get_data = $this->uang_masuk->get_data_id($kode_donatur);
            $nama_donatur = $get_data[0]['nama_donatur'];
            $nowa = $get_data[0]['nowa'];
            ...
            // var_dump($data);
            if ($hasil = $this->uang_masuk->edit_data($data, $id_uang_masuk) > 0) {
