        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    <div class="mb-4">
                        <a href="#modal-tambah" data-bs-toggle="modal" class="btn btn-primary btn-rounded fs-18">+ Donatur Tetap</a>
                    </div>
                                ...
                                <form action="<?= base_url('admin/donatur/tambah_donatur') ?>" method="POST">
                                    <div class="modal-body">
                                        <div class="basic-form">
                                            ...
                                            <div class="mb-3 row">
                                                <label class="col-sm-3 col-form-label">Iuran Pokok</label>
                                                <div class="col-sm-9">
                                                    <input type="tel" name="rupiah" required class="form-control" id="rupiah" value="1000000">
                                                </div>
                                            </div>
                            ...
                            <table id="example3" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Rp. <?php echo number_format($data['wajib'], 0, ',', ','); ?></td>
                                        <td>
                                            Rp. <?php echo number_format($grand_total, 0, ',', ','); ?>
                                        </td>
                                        <td>
                                            Rp. <?php echo number_format($grand_total - $data['wajib'], 0, ',', ','); ?>
                                        </td>
                                        <td>
                                            <div class="d-flex">
                                    ...
                                    <div class="modal fade bd-example-modal-lg" id="modal-edit<?= $data['kode_donatur'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form action="<?= base_url('admin/donatur/edit_donatur') ?>" method="POST">
                                                    <div class="modal-body">
                                                        <div class="basic-form">
                                                            <div class="mb-3 row">
                                                                <label class="col-sm-3 col-form-label">Kode Donatur</label>
                                                            ...
                                                            <div class="mb-3 row">
                                                                <label class="col-sm-3 col-form-label">Iuran Pokok</label>
                                                                <div class="col-sm-9">
                                                                    <input type="tel" name="rupiah" required class="form-control" id="editrupiah" value="1000000">
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="modal fade bd-example-modal-lg" id="modal-hapus<?= $data['kode_donatur'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog ">
                                            <div class="modal-content">
                                                ...
                                                <form action="<?= base_url('admin/donatur/hapus_donatur') ?>" method="POST">
                                                    <div class="modal-body">
                                                        <div class="basic-form">
                                                            <div class="mb-3 row">
                                                                <label class="col-sm-3 col-form-label">Kode Donatur</label>
